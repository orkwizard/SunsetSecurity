...
@ServerClass("mx.com.sunset.heimdall.ui.view.orderedit.OrderEditViewDesign")
@AutoGenerated
public class OrderEditViewDesignElement extends VerticalLayoutElement {
	...
	public OrderHistoryElement getHistory() {
		return $(mx.com.sunset.heimdall.ui.view.orderedit.OrderHistoryElement.class).id("history");
	}
